...
-- -------------------------
-- Routines for trip planner
-- -------------------------

-- -------------------------
-- Procedure get_cities_in_country
-- -------------------------

USE `world`;
DROP PROCEDURE IF EXISTS `world`.`get_cities_in_country`;

DELIMITER $
USE `world`$
CREATE PROCEDURE `world`.`get_cities_in_country`(in var_country varchar(52))
BEGIN
...
USE `world`;
DROP PROCEDURE IF EXISTS `world`.`get_countries`;

DELIMITER $
USE `world`$
CREATE PROCEDURE `world`.`get_countries`()
BEGIN
    declare exit handler for sqlexception
    begin
        rollback;
...
GRANT EXECUTE ON PROCEDURE `world`.`get_cities_in_country` TO user;
GRANT EXECUTE ON PROCEDURE `world`.`get_countries` TO user;
